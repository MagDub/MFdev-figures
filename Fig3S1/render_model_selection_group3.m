...
function [] = render_model_selection_group3(ybounds, increment)
    
    % Data
    load('../data_for_figs_2/model_cv.mat')
    
    model_cv(model_cv(:,1)<300,:)=[];
    ...
    % Number and title
    text(0-0.15, 1+0.18,'c','Units', 'Normalized', 'VerticalAlignment', 'Top','FontSize', 26)
    t=title('Late adolescents','FontSize', 18, 'FontName','Arial', 'Fontweight','normal');
