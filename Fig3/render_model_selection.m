...
function [] = render_model_selection(ybounds, increment)
    ...
    text(x([4])+0.25,mean_all(I(4))+0.2,['1^{st}'],'vert','bottom','horiz','center','FontName','Arial','Fontweight','bold','FontSize',12); 
    text(x([8])+0.25,mean_all(I(8))+0.2,['2^{nd}'],'vert','bottom','horiz','center','FontName','Arial','Fontweight','bold','FontSize',12);
    text(x([12])+0.25,mean_all(I(12))+0.2,['3^{rd}'],'vert','bottom','horiz','center','FontName','Arial','Fontweight','bold','FontSize',12);
    box off
